...
import { PPFundingOracle } from "./PPFundingOracle.sol";


/**
 * @title PPInverseFundingOracle
 * @author Pulsar
 *
 * @notice PPFundingOracle that uses the inverted rate (i.e. flips base and quote currencies)
 *  when getting the funding amount.
 */
contract PPInverseFundingOracle is
    PPFundingOracle
{
    // ============ Constructor ============
    ...
    constructor(
        ...
        PPFundingOracle(fundingRateProvider)
        public
    {
    }
