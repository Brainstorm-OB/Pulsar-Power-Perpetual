...
/**
 * @title PPFundingOracle
 * @author Pulsar
 *
 * @notice Oracle providing the funding rate for a power perpetual market.
 */
contract PPFundingOracle is
    Ownable,
    I_PPFunder
{
    ...
    PPTypes.Index private _FUNDING_RATE_;
    ...
    {
        // Note: Funding interest in PowerPerpetual does not compound, as the interest affects margin
        // balances but is calculated based on position balances.
        PPTypes.Index memory fundingRate = _FUNDING_RATE_;
        ...
        returns (SignedMath.Int memory)
    {
        ...
        PPTypes.Index memory oldRateWithTimestamp = _FUNDING_RATE_;
