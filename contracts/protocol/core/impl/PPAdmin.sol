    ...
    PPFinalSettlement
{
     ...
     * @dev Must be called by the PowerPerpetual admin. Emits the LogSetGlobalOperator event.
     *
     ...
     * @dev Must be called by the PowerPerpetual admin. Emits the LogSetOracle event.
     *
     ...
     * @dev Must be called by the PowerPerpetual admin. Emits the LogSetFunder event.
     *
        ...
        nonReentrant
    {
        ...
        I_PPFunder(funder).getFunding(0);
     ...
     * @dev Must be called by the PowerPerpetual admin. Emits the LogSetMinCollateral event.
     *
     ...
     * @dev Must be called by the PowerPerpetual admin. The current result of the price oracle
