 ...
 */
contract PPStorage is
    Adminable,
    ReentrancyGuard
{
    mapping(address => PPTypes.Balance) internal _BALANCES_;
    mapping(address => PPTypes.Index) internal _LOCAL_INDEXES_;
    ...
    PPTypes.Index internal _GLOBAL_INDEX_;
