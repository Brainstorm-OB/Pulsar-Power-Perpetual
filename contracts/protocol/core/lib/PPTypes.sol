 ...
 * @author Pulsar
 *
 * @dev Library for common types used in PowerPerpetual contracts.
 */
library PPTypes {
    // ============ Structs ============
    ...
    /**
     * @dev Used by contracts implementing the I_PPTrader interface to return the result of a trade.
     */
    struct TradeResult {
