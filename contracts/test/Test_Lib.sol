...
import { PPBalanceMath } from "../protocol/core/lib/PPBalanceMath.sol";
    ...
    ReentrancyGuard
{
    ...
    function copy(
        PPTypes.Balance calldata balance
    )
        external
        pure
        returns (PPTypes.Balance memory)
    {
        return PPBalanceMath.copy(balance);
    }
        ...
        returns (PPTypes.Balance memory)
    {
        ...
        PPTypes.Balance memory _balance = balance;
        PPBalanceMath.addToMargin(_balance, amount);
        return _balance;
    }
        ...
        returns (PPTypes.Balance memory)
    {
        // Copy to memory, modify in place, and return the memory object.
        PPTypes.Balance memory _balance = balance;
        PPBalanceMath.subFromMargin(_balance, amount);
        return _balance;
    }
        ...
        returns (PPTypes.Balance memory)
    {
        // Copy to memory, modify in place, and return the memory object.
        PPTypes.Balance memory _balance = balance;
        PPBalanceMath.addToPosition(_balance, amount);
        return _balance;
    }
        ...
        returns (PPTypes.Balance memory)
    {
        // Copy to memory, modify in place, and return the memory object.
        PPTypes.Balance memory _balance = balance;
        PPBalanceMath.subFromPosition(_balance, amount);
        return _balance;
    }
    ...
    {
        return PPBalanceMath.getPositiveAndNegativeValue(balance, price);
    }
    ...
    function getMargin(
        ...
        returns (SignedMath.Int memory)
    {
        return PPBalanceMath.getMargin(balance);
    }
    ...
    function getPosition(
        ...
        returns (SignedMath.Int memory)
    {
        return PPBalanceMath.getPosition(balance);
    }
        ...
        returns (PPTypes.Balance memory)
    {
        // Copy to memory, modify in place, and return the memory object.
        PPTypes.Balance memory _balance = balance;
        PPBalanceMath.setMargin(_balance, newMargin);
        return _balance;
    }
        ...
        returns (PPTypes.Balance memory)
    {
        // Copy to memory, modify in place, and return the memory object.
        PPTypes.Balance memory _balance = balance;
        PPBalanceMath.setPosition(_balance, newPosition);
        return _balance;
    }
